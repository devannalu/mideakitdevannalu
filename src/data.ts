...
export const services=['Reels & TikTok','Stories & feed','UGC, unboxing & review','Conteúdo patrocinado','Presença e cobertura de eventos','Entrevistas & palestras','Embaixadora de marca','Projetos personalizados'];
export const i18n={pt:{nav:['Sobre','Conteúdo','Trabalhos','Parcerias','Contato'],cta:'Propor uma parceria',work:'Conhecer meus trabalhos',hero:'Tecnologia no centro. Vida real ao redor.',support:'Transformo tecnologia, rotina e experiências em conversas que aproximam pessoas e marcas.'},en:{nav:['About','Content','Work','Partnerships','Contact'],cta:'Propose a partnership',work:'See my work',hero:'Technology at the center. Real life all around.',support:'I turn technology, routines and experiences into conversations that bring people and brands closer.'}};
